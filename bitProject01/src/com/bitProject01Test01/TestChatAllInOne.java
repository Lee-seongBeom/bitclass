...
public class TestChatAllInOne extends JFrame implements ActionListener, Runnable {
       ...
       public void actionPerformed(ActionEvent e) {
              if(e.getSource() == txtname || e.getSource() == btnconn) {
                     ...
                     try {
                           soc = new Socket("192.168.0.188", 9090);
       ...
       public static void main(String args[]) {
              TestChatAllInOne fr = new TestChatAllInOne();
              fr.getPreferredSize();
