...
<table width="1024" align=center>
	...
	<tr>
		...
		<table border="1">
			...
			<tr>
				<td width="100" bgcolor="#cccccc" align="center" >제목</td>
				<td colspan="5"><%=sub %></td>
			</tr>		
			...
			<tr>
				<td colspan="6" width="100" bgcolor="#cccccc" align="center">
					<a href="edit.jsp?idx=<%=num %>" align="center">[수 정]</a>
					<a href="delete.jsp?idx=<%=num %>" align="center">[삭 제]</a>
					<a href="re.jsp?ref=<%=ref%>&no=<%=no%>&lev=<%=lev%>" align="center">[답 글]</a>
				</td>
			</tr>		
